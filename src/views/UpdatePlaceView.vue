            ...
            <div class="main flex flex-col justify-center gap-10 p-10">
                ...
                <div class="flex flex-1 justify-between items-center gap-10">
                    <div class="flex flex-1 justify-start items-center">
                        <p class="text-xl font-bold whitespace-nowrap">活动地点名称：</p>
...
// 引入接口
import { addActivityPlace,getActivityPlaceById,editActivityPlace } from '../api/activityPlace';
...
onMounted(async () => {
    ...
    if (route.params.id === "create") {
        ...
        loading.value = true;
        // 获取活动信息
        await getActivityPlaceById(route.params.id as string).then((res) => {
            const data = res.data;
            console.log(data);
...
const handleAdd = async () => {
    ...
    try {
        await addActivityPlace(newData);
...
const handleEdit = async () => {
    ...
    try {
        await editActivityPlace(updatedData);
