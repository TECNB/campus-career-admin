<template>
    <div class="IssueDateView">
        <el-scrollbar>
            ...
            <IssueDateTable :dateOrder="dateOrder" :typeOrder="typeOrder"/>
        </el-scrollbar>
...
// 引入IssueDateTable
import IssueDateTable from "../components/IssueDateTable.vue"

const dateOrder = ref<string>("默认排序")
const typeOrder = ref<string>("所有发行计划")
...
//     console.log('updateIssueDate')
//     router.push('/updateIssueDate/'+id)
// }
</script>
